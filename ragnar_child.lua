...
setImplicitHandling=function()
    sim.setExplicitHandling(mainIkTask,0)
    print('Set Implicit Handling')
end
...
function sysCall_threadmain()
    ...
    --print('move to another position')
    --newPos = {0, 0, -0.1}
    --sim.setObjectPosition(ikModeTargetDummy,ikModeTargetDummy,newPos)
    --handleKinematics()
    ...
    --[[
            ...
            --]]
            print('finish the pick and place algorithm')
        end
